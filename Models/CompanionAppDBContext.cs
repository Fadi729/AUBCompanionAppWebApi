...
namespace CompanionApp.Models
{
    public partial class CompanionAppDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.Crn).HasName("PK__COURSE__C1F887FFF352CD8D");

                entity.ToTable("COURSE", "CompanionApp");

                entity.Property(e => e.Crn).ValueGeneratedNever().HasColumnName("CRN");
                ...
                entity
                    .Property(e => e.EndTime1)
                    .HasColumnType("time(0)")
                    .HasColumnName("END_TIME_1");

                entity
                    .Property(e => e.EndTime2)
                    .HasColumnType("time(0)")
                    .HasColumnName("END_TIME_2");

                entity
                    .Property(e => e.Instructor1)
                    .HasMaxLength(255)
                    .IsUnicode(false)
                    .HasColumnName("INSTRUCTOR_1");

                entity
                    .Property(e => e.Instructor2)
                    .HasMaxLength(255)
                    .IsUnicode(false)
                ...
                entity
                    .Property(e => e.StartTime1)
                    .HasColumnType("time(0)")
                    .HasColumnName("START_TIME_1");

                entity
                    .Property(e => e.StartTime2)
                    .HasColumnType("time(0)")
            ...
            modelBuilder.Entity<Following>(entity =>
            {
                ...
                entity
                    .Property(e => e.DateFollowed)
                    .HasColumnType("datetime")
                    .HasColumnName("DATE_FOLLOWED");

                entity
                    .HasOne(d => d.IsFollowingNavigation)
            ...
            modelBuilder.Entity<Profile>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__PROFILE__161CF72470A5A43A").IsUnique();
            ...
            modelBuilder.Entity<Semester>(entity =>
            {
                ...
                entity.Property(e => e.Id).HasMaxLength(6).IsUnicode(false).HasColumnName("ID");
